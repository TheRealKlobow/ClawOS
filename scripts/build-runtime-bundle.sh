...
rm -rf "$STAGE_DIR"
mkdir -p "$PAYLOAD_DIR/etc/systemd/system" "$PAYLOAD_DIR/usr/local/bin" "$PAYLOAD_DIR/etc/clawos" "$PAYLOAD_DIR/etc/openclaw" "$PAYLOAD_DIR/etc/default" "$PAYLOAD_DIR/opt/clawos" "$PAYLOAD_DIR/opt/openclaw"

# ClawOS-managed runtime files only
cp -a "$ROOT_DIR/image/overlays/usr/local/bin/clawos" "$PAYLOAD_DIR/usr/local/bin/"
cp -a "$ROOT_DIR/image/overlays/usr/local/bin/clawos-bootstrap.sh" "$PAYLOAD_DIR/usr/local/bin/"
cp -a "$ROOT_DIR/image/overlays/usr/local/bin/clawos-doctor.sh" "$PAYLOAD_DIR/usr/local/bin/"
cp -a "$ROOT_DIR/image/overlays/usr/local/bin/clawos-fix-origin.sh" "$PAYLOAD_DIR/usr/local/bin/"
cp -a "$ROOT_DIR/image/overlays/usr/local/bin/clawos-setup-gateway.sh" "$PAYLOAD_DIR/usr/local/bin/"
cp -a "$ROOT_DIR/image/overlays/usr/local/bin/clawos-status.sh" "$PAYLOAD_DIR/usr/local/bin/"
cp -a "$ROOT_DIR/image/overlays/usr/local/bin/clawos-healthcheck.sh" "$PAYLOAD_DIR/usr/local/bin/" 2>/dev/null || true
cp -a "$ROOT_DIR/image/overlays/usr/local/bin/openclaw-gateway-preflight.sh" "$PAYLOAD_DIR/usr/local/bin/"
...
cp -a "$ROOT_DIR/image/overlays/usr/local/bin/clawos-about" "$PAYLOAD_DIR/usr/local/bin/"
...
[[ -d "$ROOT_DIR/image/overlays/etc/openclaw" ]] && cp -a "$ROOT_DIR/image/overlays/etc/openclaw/." "$PAYLOAD_DIR/etc/openclaw/"
...
chmod 0755 /usr/local/bin/clawos || true
chmod 0755 /usr/local/bin/clawos-bootstrap.sh || true
chmod 0755 /usr/local/bin/clawos-doctor.sh || true
chmod 0755 /usr/local/bin/clawos-fix-origin.sh || true
chmod 0755 /usr/local/bin/clawos-setup-gateway.sh || true
chmod 0755 /usr/local/bin/clawos-status.sh || true
chmod 0755 /usr/local/bin/openclaw-gateway-preflight.sh || true
chmod 0755 /usr/local/bin/openclaw-healthcheck.sh || true
chmod 0755 /usr/local/bin/clawos-update || true
chmod 0755 /usr/local/bin/clawos-about || true
